...
EEG technicians placed annotations during routine clinical workflow using the Persyst spike/seizure detection and clinical annotation workflow. Three annotation types are present:
