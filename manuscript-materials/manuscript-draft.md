...
| **Neurotech (this work)** | **4,914** | **23,607** | **212,186** | **Lifelines / EMS** | **Routine + ambulatory + ICU/EMU** | **Workflow-native** |
...
All recordings were acquired using Lifelines or EMS ambulatory EEG systems (with Persyst spike and seizure detection). Electrodes were placed according to the standard International 10-20 system, with typical montages including 25-29 channels: Fp1, Fp2, F3, F4, C3, C4, P3, P4, O1, O2, F7, F8, T3, T4, T5, T6, Fz, Pz, Cz, A1, A2, T1, T2, F11, F12, and an electrocardiogram (ECG) channel. Recordings span 22-30 channels (median 28); 24% contain 29 channels including the EDF+ annotation signal. Signals were sampled at 256 Hz and stored in European Data Format (EDF+C, continuous).
